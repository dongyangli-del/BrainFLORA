...
def main():
    ...
    parser.add_argument('--sub', type=str, default='sub-02', help='Subject ID to use for testing (default: sub-01)')
    ...
    # parser.add_argument('--subjects', nargs='+', default=['sub-02'], help='List of subject IDs (default: sub-01 to sub-10)')
    ...
    ], help='List of subject IDs (default: sub-01 to sub-50)')
