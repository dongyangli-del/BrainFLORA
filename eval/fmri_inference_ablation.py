...
# Configuration
MODEL_CONFIG = {
    'model_name': 'ATMS',  # 'ATMS', 'MetaEEG', 'NICE', 'EEGNetv4_Encoder', 'MindEyeModule'
...
if MODEL_CONFIG['model_name'] == 'ATMS':
    atms_module = import_from_path(
        "ATMS_retrieval_joint_train_fMRI_medformer_ablation_1",
        f"/mnt/dataset1/ldy/Workspace/EEG_Image_decode/Retrieval/ATMS_retrieval_joint_train_fMRI_medformer_ablation_1.py"
    )
...
for sub in test_subjects:
    ...
    if mode == 'joint':
        model_path = f"/mnt/dataset1/ldy/Workspace/EEG_Image_decode/Retrieval/models/contrast/across/ablation/fmri/ATMS/01-27_00-06/50.pth"
