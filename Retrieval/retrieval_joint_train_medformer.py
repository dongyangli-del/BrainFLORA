...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/mnt/dataset0/ldy/datasets/THINGS_EEG/Preprocessed_data_250Hz', help='Path to data')
    # parser.add_argument('--data_path', type=str, default='/home/ldy/4090_Workspace/4090_THINGS/Preprocessed_data_250Hz', help='Path to data')    
